...
//         epicenterPhotos?.add(Dynamic.fromJson(v));
//       });
//     }
...
//       map['epicenterPolluationSources'] = epicenterPolluationSources?.map((v) => v.toJson()).toList();
//     }
//     return map;
//   }
//
...
//         reportPotentialPollutants?.add(Dynamic.fromJson(v));
//       });
//     }
...
//   List<dynamic>? reportPotentialPollutants;
