class ReportsModels {
  ...
  ReportsModels.fromJson(dynamic json) {
    id = json['id'];
    ...
    totalPollutionIndicatorRelatedEpicenters = json['totalPollutionIndicatorRelatedEpicenters'];
    ...
    landForm = json['landForm'] != null ? LandForm.fromJson(json['landForm']) : null;
    pollutantPlace = json['pollutantPlace'] != null ? PollutantPlace.fromJson(json['pollutantPlace']) : null;
    surfaceWater = json['surfaceWater'] != null ? SurfaceWater.fromJson(json['surfaceWater']) : null;
    responsibleAuthority = json['responsibleAuthority'] != null ? ResponsibleAuthority.fromJson(json['responsibleAuthority']) : null;
    natureOfEpicenter = json['natureOfEpicenter'] != null ? NatureOfEpicenter.fromJson(json['natureOfEpicenter']) : null;
    windDirection = json['windDirection'] != null ? WindDirection.fromJson(json['windDirection']) : null;
    ...
    if (json['reportSurroundingBuildings'] != null) {
      ...
      json['reportSurroundingBuildings'].forEach((v) {
        reportSurroundingBuildings?.add(SurroundingBuilding.fromJson(v));
      });
    }
  ...
  List<SurroundingBuilding>? reportSurroundingBuildings;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['totalPollutionIndicatorRelatedEpicenters'] = totalPollutionIndicatorRelatedEpicenters;
    ...
    map['acidity'] = acidity;
    map['waterTemperature'] = waterTemperature;
    map['firstCarpone'] = firstCarpone;
    map['secoundCarpone'] = secoundCarpone;
    map['cityId'] = cityId;
    ...
    if (reportPolluationSources != null) {
      map['reportPolluationSources'] = reportPolluationSources?.map((v) => v.toJson()).toList();
    }
    if (reportPotentialPollutants != null) {
      map['reportPotentialPollutants'] = reportPotentialPollutants?.map((v) => v.toJson()).toList();
    }
    if (reportSurroundingBuildings != null) {
      map['reportSurroundingBuildings'] = reportSurroundingBuildings?.map((v) => v.toJson()).toList();
    }
    if (reportIndustrialActivities != null) {
      map['reportIndustrialActivities'] = reportIndustrialActivities?.map((v) => v.toJson()).toList();
    }
    if (reportSemanticPollutions != null) {
      map['reportSemanticPollutions'] = reportSemanticPollutions?.map((v) => v.toJson()).toList();
    }
    if (reportSurroundedMediums != null) {
      map['reportSurroundedMediums'] = reportSurroundedMediums?.map((v) => v.toJson()).toList();
    }
    if (reportPlants != null) {
      map['reportPlants'] = reportPlants?.map((v) => v.toJson()).toList();
    }
    if (reportUndergroundWaters != null) {
      map['reportUndergroundWaters'] = reportUndergroundWaters?.map((v) => v.toJson()).toList();
    }
    return map;
  }
...
class ReportPotentialPollutants {
  ...
  ReportPotentialPollutants.fromJson(dynamic json) {
    ...
    potentialPollutant = json['potentialPollutant'] != null ? PotentialPollutant.fromJson(json['potentialPollutant']) : null;
  }
...
class ReportPolluationSources {
  ...
  ReportPolluationSources.fromJson(dynamic json) {
    ...
    polluationSource = json['polluationSource'] != null ? PolluationSource.fromJson(json['polluationSource']) : null;
  }
