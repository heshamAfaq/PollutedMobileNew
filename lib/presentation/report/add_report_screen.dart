          ...
          () => reportCtrl.load.value
              ? Center(
                  child: FlipCard(
                    ...
                    front:Image.asset("assets/images/logo.png",height: 120),
                    back: Image.asset("assets/images/logo.png",height: 120),
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                        width: AppSize.s1,
                                        color:
                                            reportCtrl.responsibleId.value == 0
                                                ? Colors.red
                                                : ColorManager.grey),
                                    borderRadius: BorderRadius.circular(
                                        BorderRadiusValues.br5),
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                        width: AppSize.s1,
                                        color:
                                            reportCtrl.surfaceWaterId.value == 0
                                                ? Colors.red
                                                : ColorManager.grey),
                                    borderRadius: BorderRadius.circular(
                                        BorderRadiusValues.br5),
                            ...
                            Padding(
                              ...
                              child: MultiSelectDialogField(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: reportCtrl
                                            .listOfsemanticPollution.isEmpty
                                        ? Colors.red
                                        : Colors.grey,
                                  ),
                                ),
                            ...
                            GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                        width: AppSize.s1,
                                        color: reportCtrl.natureOfEpicenterId
                                                    .value ==
                                                0
                                            ? Colors.red
                                            : ColorManager.grey),
