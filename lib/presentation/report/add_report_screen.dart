                                ...
                                builder: (ctx) =>
                                    SizedBox(
                                        height: SizeConfig.screenHeight! /
                                            MediaSize.m2_5,
                                        child: ListView.builder(
                                            itemCount: reportCtrl.allregion
                                                .length,
                                            itemBuilder: (context, index) {
                                              return InkWell(
                                                onTap: () {
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                          "${reportCtrl.distanceOfList[index]
                                              .surroundingBuilding!
                                              .name!}:  ${reportCtrl
                    ...
                    reportCtrl.water.value == true ||
                      ...
                      children: [
                        reportCtrl.water.value == true &&
                            ...
                            ? LabelWidget(
                            label:
                            "${"Water Pollution".tr} و ${"Soil contamination"
                                .tr}")
                            : reportCtrl.water.value == true
                            ? LabelWidget(
